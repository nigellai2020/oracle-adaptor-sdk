...
class OSWAP_OracleChained extends eth_wallet_1.Contract {
    ...
    async oraclesStore(params) {
        let result = await this.call('oraclesStore', [params.param1, params.param2, eth_wallet_1.Utils.toString(params.param3)]);
        return result;
    }
    async pathsStore(params) {
        let result = await this.call('pathsStore', [params.param1, params.param2, eth_wallet_1.Utils.toString(params.param3)]);
        return result;
    }
