...
class OSWAP_OracleChainlink extends eth_wallet_1.Contract {
    ...
    assign() {
        ...
        let getRatioParams = (params) => [params.from, params.to, eth_wallet_1.Utils.toString(params.param3), eth_wallet_1.Utils.toString(params.param4), eth_wallet_1.Utils.stringToBytes(params.param5)];
