...
class OSWAP_OracleChainlinkPriceGuardGeneric extends eth_wallet_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, Bin.abi, Bin.bytecode);
    }
    deploy(params) {
        return this._deploy(params.weth, params.wethPriceFeed, params.tokens, params.pricefeeds, params.factory, eth_wallet_1.Utils.toString(params.maxValue), eth_wallet_1.Utils.toString(params.deviation), params.returnAmmPrice);
    }
    async WETH() {
