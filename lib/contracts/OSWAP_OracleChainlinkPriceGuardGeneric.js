...
class OSWAP_OracleChainlinkPriceGuardGeneric extends eth_wallet_1.Contract {
    ...
    deploy(params) {
        return this.__deploy([params.weth, params.wethPriceFeed, params.tokens, params.pricefeeds, params.factory, eth_wallet_1.Utils.toString(params.maxValue), eth_wallet_1.Utils.toString(params.deviation), params.returnAmmPrice]);
    }
    assign() {
        let WETH_call = async () => {
