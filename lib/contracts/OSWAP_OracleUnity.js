...
class OSWAP_OracleUnity extends eth_wallet_1.Contract {
    ...
    async getRatio(params) {
        let result = await this.call('getRatio', [params.param1, params.param2, eth_wallet_1.Utils.toString(params.param3), eth_wallet_1.Utils.toString(params.param4), params.param5]);
        return {
