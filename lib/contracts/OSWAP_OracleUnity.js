...
class OSWAP_OracleUnity extends eth_wallet_1.Contract {
    ...
    async getLatestPrice(params) {
        let result = await this.call('getLatestPrice', [params.param1, params.param2, eth_wallet_1.Utils.stringToBytes(params.param3)]);
        return new eth_wallet_1.BigNumber(result);
    }
    async getRatio(params) {
        let result = await this.call('getRatio', [params.param1, params.param2, eth_wallet_1.Utils.toString(params.param3), eth_wallet_1.Utils.toString(params.param4), eth_wallet_1.Utils.stringToBytes(params.param5)]);
        return {
