...
import Bin from "./OSWAP_OracleChainlinkPriceGuardFiatGeneric.json";

export interface IDeployParams {tokens:string[];pricefeeds:string[];factory:string;maxValue:number|BigNumber;deviation:number|BigNumber;returnAmmPrice:boolean}
...
export class OSWAP_OracleChainlinkPriceGuardFiatGeneric extends Contract{
    ...
    deploy(params: IDeployParams): Promise<string>{
        return this.__deploy([params.tokens,params.pricefeeds,params.factory,Utils.toString(params.maxValue),Utils.toString(params.deviation),params.returnAmmPrice]);
    }
    WETH: {
        (): Promise<string>;
    }
