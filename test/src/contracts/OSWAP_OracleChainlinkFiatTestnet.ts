...
const Bin = require("../../bin/OSWAP_OracleChainlinkFiatTestnet.json");

export class OSWAP_OracleChainlinkFiatTestnet extends Contract{
    constructor(wallet: Wallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
    }
    deploy(params:{tokens:string[],pricefeed:string[]}): Promise<string>{
        return this._deploy(params.tokens,params.pricefeed);
    }
