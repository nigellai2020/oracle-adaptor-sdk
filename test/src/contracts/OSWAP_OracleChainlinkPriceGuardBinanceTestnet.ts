...
const Bin = require("../../bin/OSWAP_OracleChainlinkPriceGuardBinanceTestnet.json");

export class OSWAP_OracleChainlinkPriceGuardBinanceTestnet extends Contract{
    constructor(wallet: Wallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
    }
    deploy(params:{wbnb:string,dai:string,factory:string,maxValue:number|BigNumber,deviation:number|BigNumber,useAmmPrice:boolean}): Promise<string>{
        return this._deploy(params.wbnb,params.dai,params.factory,Utils.toString(params.maxValue),Utils.toString(params.deviation),params.useAmmPrice);
    }
