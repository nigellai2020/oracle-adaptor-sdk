...
const Bin = require("../../bin/OSWAP_OracleChainlinkPriceGuardFiatTestnet.json");

export class OSWAP_OracleChainlinkPriceGuardFiatTestnet extends Contract{
    constructor(wallet: Wallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
    }
    deploy(params:{tokens:string[],pricefeeds:string[],factory:string,maxValue:number|BigNumber,deviation:number|BigNumber,useAmmPrice:boolean}): Promise<string>{
        return this._deploy(params.tokens,params.pricefeeds,params.factory,Utils.toString(params.maxValue),Utils.toString(params.deviation),params.useAmmPrice);
    }
