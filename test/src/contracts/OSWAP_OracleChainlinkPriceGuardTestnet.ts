...
const Bin = require("../../bin/OSWAP_OracleChainlinkPriceGuardTestnet.json");

export class OSWAP_OracleChainlinkPriceGuardTestnet extends Contract{
    constructor(wallet: Wallet, address?: string){
        super(wallet, address, Bin.abi, Bin.bytecode);
    }
    deploy(params:{weth:string,wethPriceFeed:string,tokens:string[],pricefeeds:string[],factory:string,maxValue:number|BigNumber,deviation:number|BigNumber,useAmmPrice:boolean}): Promise<string>{
        return this._deploy(params.weth,params.wethPriceFeed,params.tokens,params.pricefeeds,params.factory,Utils.toString(params.maxValue),Utils.toString(params.deviation),params.useAmmPrice);
    }
